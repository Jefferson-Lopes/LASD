...
# File: Mod_Teste.tcl
# Generated on: Thu Mar 30 12:05:29 2023
...
if {[is_project_open]} {
	if {[string compare $quartus(project) "Mod_Teste"]} {
		puts "Project Mod_Teste is not open"
		set make_assignments 0
	}
} else {
	# Only open if not already open
	if {[project_exists Mod_Teste]} {
		project_open -revision Mod_Teste Mod_Teste
	} else {
		project_new -revision Mod_Teste Mod_Teste
	}
...
if {$make_assignments} {
	...
	set_global_assignment -name PROJECT_CREATION_TIME_DATE "09:06:31  MARCH 30, 2023"
	...
	set_global_assignment -name VERILOG_FILE LCD_TEST2.v
	set_global_assignment -name VERILOG_FILE Mod_Teste.v
	set_global_assignment -name SYSTEMVERILOG_FILE clock_divider.sv
	set_global_assignment -name SYSTEMVERILOG_FILE counter.sv
	set_global_assignment -name SYSTEMVERILOG_FILE hex_dec.sv
	set_global_assignment -name SYSTEMVERILOG_FILE loading_dec.sv
